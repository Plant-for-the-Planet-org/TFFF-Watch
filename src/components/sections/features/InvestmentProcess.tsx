      ...
      <div>
        ...
        <div className="typo-p">
          <p>
            ...
            expressed support for the project. However, no pledge has been made
            and no pledge amount has been discussed publicly.
          </p>
        </div>
      </div>
      <Br />
        ...
        <div className="typo-p">
          <div>
            ...
            <p>
              ...
              Wirtschaft, Handel und ländliche Entwicklung im Bundesministerium
