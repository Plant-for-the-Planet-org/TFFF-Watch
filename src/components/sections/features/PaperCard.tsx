  ...
  return (
    ...
    <div className="group flex-1/3 grow-0 shrink p-3 bg-white border border-primary-medium-light rounding-xl">
      <div className="flex flex-row gap-2 items-center">
        <div className="flex-2/5 relative mb-2 overflow-hidden rounded-lg">
          <img
            className="aspect-[4/3] object-contain transition-transform duration-300 ease-in-out group-hover:scale-110"
            src={props.image}
            alt="news"
          />
